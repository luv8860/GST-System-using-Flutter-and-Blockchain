...
class GovtPage extends StatefulWidget {
  final String uid;
  GovtPage({Key key, @required this.uid}) : super(key: key);
  @override
  _GovtPageState createState() => _GovtPageState(uid);
}

class _GovtPageState extends State<GovtPage> {
  final String uid;
  _GovtPageState(this.uid);
  ...
  var bill;
  void getgovt() async {
    var result = await Blockchain().getGovt();
    setState(() {
      amt = result[0];
      noofbusiness = result[1];
    });
  }
                      ...
                      Padding(
                        ...
                        child: FlatButton(
                          child: Card(
                              ...
                              text: "View detailsof a\nparticular business"),
                          onPressed: () {
                            buildShowModalBottomSheet3(context);
                          },
                        ),
                      ),
                    ])),
                      ...
                      child: MaterialButton(
                        ...
                        onPressed: () async {
                          var lst = await Blockchain()
                              .getBill(BigInt.from(billNo), gstNo);
  ...
  Future buildShowModalBottomSheet3(BuildContext context) {
    final _formKey = GlobalKey<FormState>();
    String gstNo;
    return showModalBottomSheet(
      context: context,
              ...
              Form(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: AutoSizeText('SEARCH NEW BUSINESS',
                          maxLines: 1,
                          style: TextStyle(
                              fontSize: 40,
                              fontWeight: FontWeight.w100,
                      ...
                      child: MaterialButton(
                        ...
                        child: Text("Find the Business",
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold)),
                        onPressed: () async {
                          var lst = await Blockchain().getBusiness(gstNo);
                                        ...
                                        children: [
                                          Column(
                                            children: [
                                              ...
                                              titleText("TOTAL BILL GENERATED"),
                                              Padding(
                                                padding:
                                                    const EdgeInsets.all(10),
                                                child: Container(
                ...
                children: [
                  ...
                  AutoSizeText('SUMMARY',
                      ...
                      style: TextStyle(
                          ...
                          fontFamily: 'Alfa Slab One')),
                  SizedBox(height: 20),
                  titleText("TOTAL BUSINESS REGISTERED"),
                  Padding(
                    padding: const EdgeInsets.all(10),
                    child: Container(
                      padding: EdgeInsets.all(10),
                      ...
                      child: TextField(
                        decoration: InputDecoration(
                            ...
                            hintText: noofbusiness.toString(),
                            hintStyle: TextStyle(color: Colors.grey),
                            border: InputBorder.none),
                      ),
                    ),
                  ),
                  titleText("TOTAL GST RECIEVED"),
                  Padding(
                    padding: const EdgeInsets.all(10),
                    child: Container(
                      padding: EdgeInsets.all(10),
